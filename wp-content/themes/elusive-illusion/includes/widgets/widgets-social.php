...
class Theme_Social_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'theme_social_widget', __('Theme Social Widget', ELUSICVE_THEME_LAN), array('description' => __('A Social Widget', ELUSICVE_THEME_LAN),)
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        foreach ($services as $service) :
            ...
            if (!empty($active[$service])) {
               echo '<li><a href="' . $active[$service] . '" target="_BLANK" class="social-icon ' . $service . '" title="' . __('Follow us on ', ELUSICVE_THEME_LAN) . $service . '"><i class="fa fa-' . $service . '"></i></a></li>';
