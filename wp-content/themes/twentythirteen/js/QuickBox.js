...
var QuickBox = new Class({
	...
	changeImage: function(event, step){
		...
		var total = this.anchors.length -1;
		
		if(total == this.currentIndex && step== 1 ) this.currentIndex = -1;
		
		 if(this.currentIndex ==0  && step == -1) this.currentIndex = total+1;
		//alert(this.currentIndex +"   ----   "  + total);
