...
<div id="container" style="display:none">
    <div id="sidebar"><!-- InstanceBeginEditable name="sidebar" -->
        <div class="top"><?php echo $page_title;
get_heading($group); ?></div>
        <div class="bottom">
...
<div id="menu" style="position:relative; top:625px">        
    <a class="right logo-link" href="<?php echo $root; ?>"><img src="wp-content/themes/twentythirteen/images/logo.png"  alt="Crowne Plaza" /></a>
    <a href="javascript:void(0)" class="toggle-menu"></a>

    <a class="menu-item" style="padding-left:40px;" href="<?php echo $root; ?>?page_id=30"><img border="2" height="63"  width="63" src="wp-content/themes/twentythirteen/images/res.png"    onmouseover="change_hover(this, 'restuarants_on.png', 'restaurants')"   onmouseout="change(this, 'res.png')"   alt="Crown Plaza restaurants" /><span class="sr">Restaurants</span></a>
    <a class="menu-item" href="<?php echo $root; ?>?page_id=12"><img src="wp-content/themes/twentythirteen/images/bar.png"  height="63"  width="63"  onmouseover="change_hover(this, 'bars_on.png', 'bars')"   onmouseout="change(this, 'bar.png')"   alt="Crown Plaza Bars" /><span class="sr">Bars</span></a>
    <a class="menu-item" href="" <?php echo $glance_link; ?>><img border="2"  height="63"  width="63"  src="wp-content/themes/twentythirteen/images/ofrs.png"   onmouseover="change_hover(this, 'promotions_on.png', 'promotions')"   onmouseout="change(this, 'ofrs.png')"   alt="Crown Plaza Bars"  /><span class="sr">Promotions</span></a>
    <a class="menu-item" href="<?php echo $root; ?>?page_id=39"><img border="2"  height="63"  width="63" src="wp-content/themes/twentythirteen/images/photo.png"  onmouseover="change_hover(this, 'meetings_on.png', 'conference 	and banqueting')"   onmouseout="change(this, 'photo.png')"  alt="Menu" /><span class="sr">Conference and Banqueting</span></a>
    <a class="menu-item" href="<?php echo $root; ?>?page_id=43"><img border="2"  height="63"  width="63"  src="wp-content/themes/twentythirteen/images/video.png"  onmouseover="change_hover(this, 'gallery_on.png', 'gallery')"   onmouseout="change(this, 'video.png')"  alt="Menu" /><span class="sr">Gallery</span></a>
