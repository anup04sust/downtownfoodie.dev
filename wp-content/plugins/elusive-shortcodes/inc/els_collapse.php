...
function els_collapse( $params, $content=null ){
...
add_shortcode( 'els_collapse', 'els_collapse' );


function els_citem( $params, $content=null ){
    extract( shortcode_atts( array(
        'id'=> '',
...
add_shortcode('els_citem', 'els_citem' );
